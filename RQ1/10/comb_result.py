    ...
    for p_name in project_name_list:
        ...
        for cosine_sim_threshold in range(1, 10):
            ...
            for num_ite in range(1, max_iteration+1):
                ...
                temp_dict = util.load_pickle("./data/{0}_nsd_similarity_costh{1}_ite{2}.pickle".format(p_name, cosine_sim_threshold, num_ite))
            ...
            util.dump_pickle("./data/{0}_nsd_similarity_costh{1}.pickle".format(p_name, cosine_sim_threshold), issue2hash_dict)
